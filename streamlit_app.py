...
/* Oculta botão flutuante padrão do Streamlit (deploy etc.), mas NÃO tudo que é fixo no canto */
...
# -------------------
QUESTOES = [
    {"id": "1.1.1", "texto": "Identificam-se as forças e fraquezas, assim como as oportunidades e ameaças provenientes dos contextos internos e externos da organização para formulação/revisão das estratégias.", "dimensao": "Agenda Estratégica"},
    ...
    {"id": "1.4.2", "texto": "Os objetivos estratégicos consideram o mandato institucional que norteia a atuação da organização; desafios e oportunidades provenientes dos contextos externos e incumprimento legais?", "dimensao": "Agenda Estratégica"},
    ...
    {"id": "2.3.1", "texto": "As definições de atribuições contemplam claramente devolutivas, mecanismos de articulação institucional e conflitos gerados pelas áreas de interface com os demais órgãos, entidades e organismos autônomos?", "dimensao": "Alinhamento da Estrutura implementadora"},
    ...
    {"id": "2.6.3", "texto": "A organização dispõe de estrutura formal definida pela direção para o dimensionamento de recursos humanos e apostilando quais os desdobramentos decorrentes da situação de falta?", "dimensao": "Alinhamento da Estrutura implementadora"},
    ...
    {"id": "3.6.1", "texto": "Os acordos formalizados por meio de cooperação técnica, parcerias, convênios, contratos, termos de ajustamento e instrumentos congêneres contêm regras para propriedade, posse compartilhada e uso público de informações, bases de dados, sistemas de informação e tecnologias", "dimensao": "Monitoramento e Avaliação"},
